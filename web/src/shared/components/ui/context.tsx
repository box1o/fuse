...
const ContextMenuRoot: React.FC<ContextMenuProps> = ({ ...props }) => {
...
const ContextMenuRadioGroup: React.FC<ContextMenuRadioGroupProps> = ({ ...props }) => {
...
const ContextMenuSubContent: React.FC<ContextMenuSubContentProps> = ({ className, ...props }) => {
    return (
...
const ContextMenuContent: React.FC<ContextMenuContentProps> = ({ className, ...props }) => {
    return (
...
const ContextMenuRadioItem: React.FC<ContextMenuRadioItemProps> = ({ className, children, ...props }) => {
    return (
...
const ContextMenuLabel: React.FC<ContextMenuLabelProps> = ({ className, inset, ...props }) => {
    return (
...
const ContextMenuShortcut: React.FC<ContextMenuShortcutProps> = ({ className, ...props }) => {
    return (
        <span
...
const ContextMenu: React.FC<ContextMenuProps> & {
    ...
    CheckboxItem: React.FC<ContextMenuCheckboxItemProps>;
    RadioItem: React.FC<ContextMenuRadioItemProps>;
    Label: React.FC<ContextMenuLabelProps>;
    Separator: React.FC<ContextMenuSeparatorProps>;
    Shortcut: React.FC<ContextMenuShortcutProps>;
    Group: React.FC<ContextMenuGroupProps>;
    Portal: React.FC<ContextMenuPortalProps>;
    ...
    RadioGroup: React.FC<ContextMenuRadioGroupProps>;
